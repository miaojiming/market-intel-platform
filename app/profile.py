...
KNOWN_DOMAINS = {
    ...
    "krung thai": "krungthai.com",
    "krungthai bank": "krungthai.com",
    "京都银行": "krungthai.com",
    "bbl": "bbl.co.th",
    "bangkok bank": "bbl.co.th",
    "曼谷银行": "bbl.co.th",
    "bay": "bankofayudhya.co.th",
    "bank of ayudhya": "bankofayudhya.co.th",
    "krungsri": "krungsri.com",
    "bank of ayutthaya": "krungsri.com",
    "大城银行": "krungsri.com",
    "tmb": "tmbthanachart.com",
    "tmb thanachart": "tmbthanachart.com",
    "cimb thai": "cimbthai.com",
    "cimb": "cimbthai.com",
    "uob": "uob.co.th",
    ...
    "true money": "truemoney.com",
    "promptpay": "promptpay.io",
    "rabbit line pay": "rabbitlinepay.com",
    "airpay": "airpay.co.th",
    "shopeePay": "shopee.co.th",
}

# 已知的 Wikipedia 页面名映射（公司简称/别名 → Wikipedia 页面标题）
KNOWN_WIKI_NAMES = {
    "kbank": "Kasikornbank",
    "kasikornbank": "Kasikornbank",
    "kasikorn bank": "Kasikornbank",
    "开泰银行": "Kasikornbank",
    "scb": "Siam_Commercial_Bank",
    "siam commercial bank": "Siam_Commercial_Bank",
    "汇商银行": "Siam_Commercial_Bank",
    "ktb": "Krung_Thai_Bank",
    "krungthai": "Krung_Thai_Bank",
    "krung thai": "Krung_Thai_Bank",
    "krungthai bank": "Krung_Thai_Bank",
    "京都银行": "Krung_Thai_Bank",
    "bbl": "Bangkok_Bank",
    "bangkok bank": "Bangkok_Bank",
    "曼谷银行": "Bangkok_Bank",
    "bay": "Bank_of_Ayudhya",
    "bank of ayudhya": "Bank_of_Ayudhya",
    "krungsri": "Bank_of_Ayudhya",
    "大城银行": "Bank_of_Ayudhya",
    "tmb": "TMB_Thanachart_Bank",
    "tmb thanachart": "TMB_Thanachart_Bank",
    "cimb thai": "CIMB_Thai",
    "cimb": "CIMB_Group",
    "uob": "United_Overseas_Bank",
...
def _build_source_urls(company: str) -> List[Dict]:
    ...
    urls = []
    # 1. Wikipedia（优先使用已知映射，避免简称找不到页面）
    wiki_name = KNOWN_WIKI_NAMES.get(company_lower, company.replace(" ", "_"))
    urls.append(
        {
            "name": "Wikipedia",
